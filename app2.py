...
if page_selection == 'Prediction':
    ...
    st.markdown('**Note:** This is a demo and the prediction might not be accurate. We acknowledge this and will continue working to make it more accurate for you')
